  ...
  int main() {
    ...
    if(end == 1) {
      ...
      */
      ...
      sleep(2);
      printf("\033[036mSCORE: %d\n\n\033[0m", score);
      printf("\033[036mBONUS FOR WIN: %d\n\n\033[0m", 300);
  ...
  void setup() {
    ...
    */
    ...
    if (instruct == 's') {
      ...
      printf("\033[037m	5)The enemies shoot down 'V's at you. Avoid them or be terminated\033[0m\n");
  ...
  void down() {
    ...
    for(j = 0; j < 30; j++)
    {
      ...
      for(i = 30; i < 0; i--)
      {
        ...
        if(board[i][j] == 'V' && board[i+1][j]==' ' && (board[i-1][j] == 'O' || board[i-1][j] == 'M'))
        {
  ...
  void down2() {
    ...
    for(j = 0; j < 30; j++)
    {
      ...
      for(i = 30; i > 0; i--)
      {
        ...
        else if(board[29][j] == 'V' && board2[j] != board2[x]) {
          board[29][j] = ' ';
        }
        else if(board[i][j] == 'V' && board[i+1][j] == '^') {
          board[i][j] = ' ';
          board[i+1][j] = 'V';
        }
      }
...
//================================================================================
  ...
  void player() {
    ...
    if(board2[x] == 'A') {
      ...
      /*if(input == ' ' && bullets > 0 && board[28][x] != 'V') {
        board[28][x] = '^';
        bullets--;
        system("(afplay pew.mp3) &");
      }*/

      if(input == ' ' && board[28][x] != 'V') {
        board[28][x] = '^';
        bullets--;
        system("(afplay pew.mp3) &");
      }
